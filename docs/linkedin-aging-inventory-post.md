...
**Canada** — one site at Gimli holds 1.5 million barrels. There is no national
count. Nobody has one.
...
Three rules I held to, because most versions of this number are inflated by the
same three mistakes:
...
guesses and I'd like them not to be.
...
3. **Angel's share** — already on the roadmap in CLAUDE.md, and it pairs with
   this naturally: how much of those 57 million casks evaporates each year.
