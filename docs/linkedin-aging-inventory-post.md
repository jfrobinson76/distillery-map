> **Moved 16 Sep 2026:** the social card, HTML and build script now live in the Stillbound repo at
> `apps/stillbound-site/research/aging-inventory/social/`, beside the page they promote. Paths below updated.
...
- **Social asset (current):** `stillbound/apps/stillbound-site/research/aging-inventory/social/aging-inventory-map-card.html`, generated by
  `stillbound/apps/stillbound-site/research/aging-inventory/social/build-map-card.mjs`. Barrel-stack world map in Stillbound creative.
  Exported to `stillbound/apps/stillbound-site/research/aging-inventory/social/aging-inventory-map-card-1200.png` (2400x2400, retina 2x —
...
`stillbound/apps/stillbound-site/research/aging-inventory/social/aging-inventory-card.html`.)
...
Image: `stillbound/apps/stillbound-site/research/aging-inventory/social/aging-inventory-map-card-1200.png` (2400x2400 retina, upload as-is).
...
Stillbound-creative barrel-stack map (`stillbound/apps/stillbound-site/research/aging-inventory/social/build-map-card.mjs`), Japan labelled
